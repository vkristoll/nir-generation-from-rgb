...
def save_visuals(real3b_t, realNIR_t, fakeim, epoch, i, log_path):
    """
    Saves a 2x2 grid of input, generated, ground truth, and composite output images.

    """
    A = real3b_t[0].detach().cpu()         # shape: [3, H, W]
    ...
    B4 = torch.stack([fakeim.squeeze(0), A[2], A[1]])   # generated + red + green

    plt.figure(figsize=(10, 10))
    titles = ["input image234", "generated image", "ground truth", "output image234"]
    images = [
        B3,
        fakeim.unsqueeze(0),     # shape [1, 1, H, W]
