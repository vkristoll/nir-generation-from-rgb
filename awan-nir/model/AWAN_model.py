# models/AWAN_model.py

'''
Reference: 
J. Li, C. Wu, R. Song, Y. Li, and F. Liu, ‘‘Adaptive weighted attention net-
work with camera spectral sensitivity prior for spectral reconstruction from
RGB images,’’ in Proc. IEEE/CVF Conf. Comput. Vis. Pattern Recognit.
Workshops (CVPRW), Jun. 2020, pp. 1894–1903.
'''
...
class AWAN(nn.Module):
    def __init__(self, inplanes=3, planes=1, channels=100, n_DRBs=8): #changed planes to 1 from 31
