# models/MSTplusplus_model.py

'''
Reference:
Y. Cai, J. Lin, Z. Lin, H. Wang, Y. Zhang, H. Pfister, R. Timofte, and
L. V. Gool, ‘‘MST++: Multi-stage spectral-wise transformer for efficient
spectral reconstruction,’’ in Proc. IEEE/CVF Conf. Comput. Vis. Pattern
Recognit. Workshops (CVPRW), Jun. 2022, pp. 744–754.
'''
...
class MST_Plus_Plus(nn.Module):
    def __init__(self, in_channels=3, out_channels=31, n_feat=31, stage=3):
        ...
        self.conv_outb = nn.Conv2d(n_feat, 1, kernel_size=3, padding=(3 - 1) // 2,bias=False)
